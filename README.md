...
It provides standard CRUD operations for core entities and dedicated endpoints for many-to-many relationships such as customer↔account access, employee↔branch assignments, and employee↔account permissions.
...
3. Update the SQL Server connection string in:
   * `Common.Persistence/BankDbContext.cs → OnConfiguring()`
...
## 🔐 Authentication & Access Rules (high level)
- Manager
